...
import {GiftedChat, Actions, InputToolbar, Send, IMessage} from '../Components/ChatScreen'
...
export default connect(mapStateToProps,/** mapDispatchToProps*/ null)(ChatScreen)
