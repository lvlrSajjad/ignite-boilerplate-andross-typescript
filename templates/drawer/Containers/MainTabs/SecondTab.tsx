  ...
  render() {
    return (
      <View style={styles.mainContainer}>
        ...
        <NavHeaders onPress={()=>{this.props.navigation.dispatch(DrawerActions.toggleDrawer())}} title="Second"/>
...
export default connect(/**mapStateToProps*/ null,/** mapDispatchToProps*/null)(SecondTab);
